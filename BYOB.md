...
```yaml
- uses: slsa-framework/slsa-github-generator/actions/delegator/setup-generic@v3.0.0
```
...
```yaml
- uses: slsa-framework/slsa-github-generator/.github/workflow/delegator_generic_slsa3.yml@v3.0.0
  with:
...
slsa-run:
  ...
  uses: slsa-framework/slsa-github-generator/.github/workflows/delegator_generic_slsa3.yml@v3.0.0
  with:
    slsa-token: ${{ needs.slsa-setup.outputs.slsa-token }}
  secrets:
