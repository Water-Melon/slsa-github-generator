...
jobs:
  build:
    permissions:
      ...
      actions: read
      packages: read
    uses: slsa-framework/slsa-github-generator/.github/workflows/builder_gradle_slsa3.yml@v3.0.0
    with:
...
publish:
  ...
  steps:
    - name: publish
      id: publish
      uses: slsa-framework/slsa-github-generator/actions/gradle/publish@v3.0.0
      with:
